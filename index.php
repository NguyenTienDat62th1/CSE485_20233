...
<body>
    <header>
        ...
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <img src="images/slideshow/anh1.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="images/slideshow/anh2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
    ...
    <main class="container-fluid mt-3">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    <img src="images/songs/JustinBieber.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="" class="text-decoration-none">Justin Bieber</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    <img src="images/songs/Shang-Chi_score.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="" class="text-decoration-none">Shang Chi Album</a>
                        </h5>
                    </div>
                </div>
            </div>
